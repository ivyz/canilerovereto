...
<html lang="en">
  ...
  <body>
	...
	<img id="bigimage" src="img/leo1.jpg" height="330" width="550" alt="camera"/>

	<img src="img/leo1.jpg" height="90" width="120" alt="camera" onclick="changeImage('leo1')"/>
	<img src="img/leo2.jpg" height="90" width="120" alt="camera" onclick="changeImage('leo2')"/>
	<img src="img/leo3.jpg" height="90" width="120" alt="camera" onclick="changeImage('leo3')"/>
	<hr>
